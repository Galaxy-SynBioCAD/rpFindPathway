        ...
        if 'ec-code' in measured_reaction_miriam:
            for sim_reaction_id in sim_rpsbml.readRPpathwayIDs(pathway_id):
                ...
                if 'ec-code' in sim_reaction_miriam:
                    ...
                    if any(i in measured_ec for i in sim_ec) and ec_reactions_match[measured_reaction_id]['score']<1.0:
                    ...
                    if any(i in measured_frac_ec for i in sim_frac_ec) and ec_reactions_match[measured_reaction_id]['score']<0.5:
